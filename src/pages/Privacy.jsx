  ...
  return (
    <div className="mt-2">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 pt-[90px]">
        ...
        <p className="mb-4">
          Isosales POS is committed to protecting your privacy and ensuring the
        ...
        <ul className="list-disc ml-8 mb-4">
          ...
          <li>Improve and personalize the Isosales POS platform.</li>
        ...
        <p className="mb-4">
          Isosales POS does not sell, trade, or rent your personal information to
        ...
        <p className="mb-4">
          Isosales POS retains your personal information for as long as necessary
        ...
        <p className="mb-4">
          ...
          you access through Isosales POS.
        </p>
        ...
        <p className="mb-4">
          Isosales POS reserves the right to update this Privacy Policy at any
